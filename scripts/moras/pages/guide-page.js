        ...
        <div class="guide-step-row">
          ...
          <div class="guide-char-col">
            ...
            <div class="char-speech-bubble bubble-purple">
              ...
              <b>🔒 개인정보 보호 안내:</b> 입력하신 구체적인 <b>생년월일과 태어난 시간 정보는 시스템 데이터베이스에 절대로 저장되지 않으며</b>, 오직 사주 오행(예: 병오/임진/갑술) 연산만을 위한 일회성 변환에만 사용되고 즉시 폐기되니 안심하고 기입하렴!<br><br>
        ...
        <div class="guide-step-row">
          ...
          <div class="guide-char-col">
            ...
            <div class="char-speech-bubble bubble-purple">
              ...
              나를 상징하는 일주(일간과 일지)와 천간, 지지, 십성, 12운성 등 우주의 기운이 정밀하게 연산되어 표시되며, 이를 통해 내가 어떤 기운이 강하고 어떤 상대가 내 부족한 기운을 채워줄 수 있을지 미리 살펴볼 수 있단다!<br><br>
              <b>🔒 안심하세요:</b> 화면에 임시로 노출되는 생년월일시 정보는 본인 확인을 위한 연산 화면일 뿐이며, <b>서버나 데이터베이스에는 오직 계산 완료된 '사주 팔자(천간지지)' 정보만 기록</b>됩니다. 관리자 대시보드 화면에서도 생년월일은 전혀 노출되지 않는단다!"
            </div>
          </div>
        ...
        <div class="guide-step-row">
          ...
          <div class="guide-char-col">
            ...
            <div class="char-speech-bubble bubble-pink">
              ...
              우리 두 사람의 케미가 완벽하게 성립된 영광스러운 순간이란다! 우주가 이어준 기적 같은 매칭을 다 함께 축하하자! 💚🎉"
            </div>
          </div>
